...
using Cuahangchamsocthucung.Models.TokenAuth;
using Cuahangchamsocthucung.Web;
...
{
    public abstract class CuahangchamsocthucungWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static CuahangchamsocthucungWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(CuahangchamsocthucungWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<CuahangchamsocthucungDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<CuahangchamsocthucungDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<CuahangchamsocthucungDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<CuahangchamsocthucungDbContext, Task<T>> func)
        {
            T result;

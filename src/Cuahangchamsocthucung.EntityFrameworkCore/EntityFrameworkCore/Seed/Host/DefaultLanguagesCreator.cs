...
namespace Cuahangchamsocthucung.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = CuahangchamsocthucungConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(CuahangchamsocthucungDbContext context)
        {
            _context = context;
        }

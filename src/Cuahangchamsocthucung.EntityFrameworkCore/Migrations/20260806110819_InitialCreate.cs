        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_KhachHangs_AbpUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AbpUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Loaithucung = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Cannangtu = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BangGias_DichVus_DichVuId",
                        column: x => x.DichVuId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LichChamSocs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LichChamSocs_BangGias_BangGiaId",
                        column: x => x.BangGiaId,
                        principalTable: "BangGias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LichChamSocs_DichVus_DichVuId",
                        column: x => x.DichVuId,
                        principalTable: "DichVus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LichChamSocs_KhachHangs_KhachHangId",
                        column: x => x.KhachHangId,
                        principalTable: "KhachHangs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LichChamSocs_NhanViens_NhanVienId",
                        column: x => x.NhanVienId,
                        principalTable: "NhanViens",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LichChamSocs_BangGiaId",
                table: "LichChamSocs",
                column: "BangGiaId");

            migrationBuilder.CreateIndex(
                name: "IX_LichChamSocs_DichVuId",
                table: "LichChamSocs",
                column: "DichVuId");

            migrationBuilder.CreateIndex(
                name: "IX_LichChamSocs_KhachHangId",
                table: "LichChamSocs",
                column: "KhachHangId");

            migrationBuilder.CreateIndex(
                name: "IX_LichChamSocs_NhanVienId",
                table: "LichChamSocs",
                column: "NhanVienId");

            migrationBuilder.CreateIndex(
                name: "IX_NhanViens_SDT",
                table: "NhanViens",
                column: "SDT",
                unique: true);
        }
